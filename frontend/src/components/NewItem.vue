<template>
    ...
    >
        <Modal
            ...
            class="transition-all duration-300 ease-in-out z-30"
            ...
            <template v-slot:body>
                ...
                tablet:max-h-none ">
                    ...
                    pb-6">
                        <Input 
                            class="w-full"
                            color="black"
                            :placeholder=string.descriptionHolder[language]
                            :label= string.description[language]
                    ...
                    pb-6">
                        <Select 
                            class="w-full"
                            color="black"
                            :label= string.categories[language]
                    ...
                    pb-6" v-if="false">
                        <div class="flex">
                            ...
                            <Switch 
                            v-model="newItem.isRecipe" 
                            size="md"
                            color="primary"
                            exactColor
                            />
                        </div>
                        <Button v-if="newItem.isRecipe" 
                            @click="initEditRecipe = true" 
                            size="md" 
                            color="primary" 
                            exactColor
                            icon="edit" 
                            :content= string.editRecipe[language]
                        />
                    </div>
                    ...
                    pb-6">
                        <Input 
                            class="phone:mb-4 phone:w-full tablet:mb-0 tablet:mr-8 tablet:w-1/2"
                            color="black"
                            :placeholder=string.costHolder[language]
                            :label= string.cost[language]
                        ...
                        <Input
                            class="phone:w-full tablet:w-1/2"
                            color="black"
                            :placeholder= string.coin[language]
                            :label= string.coin[language]
                ...
                tablet:max-h-none ">
                    ...
                    pb-4">
                        <Autocomplete
                            color="black"
                            :placeholder= string.selectProduct[language]
                            :label= string.nameHolder[language]
                            v-model="productToRecipe.product"
                            size="md"
                            type="text"
                            :items="products"
                            value="name"
                    ...
                    pb-4">
                        <Input 
                            class="phone:mb-4 phone:w-full tablet:mb-0 tablet:mr-8 tablet:w-1/2"
                            color="black"
                            :placeholder=string.amount[language]
                            :label= string.amount[language]
                            v-model="productToRecipe.amount"
                            size="md"
                            type="number"
                        />
                        <Select
                    ...
                    pb-4">
                        <Input 
                            class="w-full phone:mb-4 tablet:mb-0"
                            color="black"
                            :placeholder= string.infoExtra[language]
                            label="Extras"
                            v-model="productToRecipe.extras"
                            size="md"
                            type="text"
                        />
                    </div>
                    ...
                    <div class="flex flex-row justify-start tablet:items-center phone:items-start pb-4">
                        <Button exactColor color="third" size="sm" class="mr-2" icon="delete" :content= string.clear[language] @click="clearProduct()" />
                        <Button exactColor color="secondary" size="sm" icon="add" :content= string.addRecipe[language] @click="addToRecipe()" />
                    </div>
                    ...
                    <div v-if="recipe.length != 0">
                        ...
                        class="flex flex-row items-center justify-between py-1 px-2 border border-black shadow-lg rounded-xl mb-2
                        hover:bg-gray-200"
                        >
