                ...
                <tr>
                    <th colspan="8">
                        <div style="min-height:80px; padding: 15px 0px">
                            ...
                            <span style="font-style: italic"> Serial de cotización:  {{$quotation->prefix_quote.str_pad(dechex($quotation->serial), 6, "0", STR_PAD_LEFT)}} </span> <br>
                            <span style="font-style: italic"> Venta </span>
